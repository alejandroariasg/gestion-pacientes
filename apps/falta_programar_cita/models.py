...
class Agenda(models.Model):
    ...
    codigo_paisa = models.CharField(max_length = 100, null=True, blank=True)
    hermanos = models.TextField(null=True, blank=True)
    persona_evalua = models.CharField(max_length = 100, null=True, blank=True)
    fecha_actualizacion = models.DateField(null=True, blank=True)
    observaciones = models.TextField(null=True, blank=True)
    hospitalizado = models.CharField(max_length = 10, null=True, blank=True)
    codigo_alternativo = models.CharField(max_length = 100, null=True, blank=True)
    procedencia  = models.CharField(max_length = 60, null=True, blank=True)
    faltan_datos_red_cap = models.CharField(max_length = 10, null=True, blank=True)
    estado = models.IntegerField(null=True, blank=True)